  ...
  class UpdateUsageMeterRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TogaiClient::UpdateUsageMeterRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TogaiClient::UpdateUsageMeterRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["COUNTER", "GAUGE", "TIMER"])
      return false unless type_validator.valid?(@type)
      return false if @aggregation.nil?
      aggregation_validator = EnumAttributeValidator.new('String', ["COUNT", "SUM"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["COUNTER", "GAUGE", "TIMER"])
    ...
    def aggregation=(aggregation)
      validator = EnumAttributeValidator.new('String', ["COUNT", "SUM"])
    ...
    def hash
      [description, type, aggregation, computations].hash
    end
